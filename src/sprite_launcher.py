#!/usr/bin/env python3
"""
AI Sprite Creator - Standalone Launcher

Main entry point for the standalone AI Sprite Creator application.
...
def main():
    ...
    from sprite_creator.ui.disclaimer import show_disclaimer_if_needed
    from sprite_creator.ui.launcher import LauncherWindow, select_character_folder
    from sprite_creator.ui.api_setup import ensure_api_key
    from sprite_creator.constants import APP_NAME, APP_VERSION
...
def run_sprite_creator():
    ...
    from sprite_creator.ui.api_setup import ensure_api_key
    from sprite_creator.ui.full_wizard import run_full_wizard
...
def run_expression_sheets():
    ...
    from sprite_creator.expression_sheets import main as run_sheet_generator
    from sprite_creator.expression_sheets import get_all_pose_paths
...
def run_sprite_tester():
    ...
    # Run the tester
    try:
        from sprite_creator.tester import launch_sprite_tester
